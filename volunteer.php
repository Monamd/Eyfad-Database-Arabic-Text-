...
<a class="navbar-brand" href="#"><img src="eyfadLogo.PNG" alt="logo" height="150" width="150" /> </a>
         ...
         session_start();
         $voID= $_SESSION['id'];
         //echo "volunteer ID: $voID";
         $sql_log_in = "SELECT volunteerName FROM volunteer WHERE volunteerEmail = '$voID'";
         $stmt_log_in = $conn->prepare($sql_log_in);
         $stmt_log_in->execute();
         $row = $stmt_log_in->fetch();
        // echo $row[volunteerName];
         echo "
<p style='text-align: center; font-family: Cairo, sans-serif;font-size: 30px;'>  مرحبا $row[volunteerName]</p>
    ...
    <div class="container-fluid container-padding">
      <div class="row">
        ...
        <div class="col-sm-3 services">
         <a href="https://drive.google.com/drive/folders/1ASDTHWtwHmdCKWx67_HW5izkvDDcm5ue?usp=sharing" target="_blank"><button type="button" class="btn btn-light btn-lg btn-block">قاعدة البيانات</button></a> <br>
  ...
  <section id="about-us" class="container-padding">
    <div align="center">
      <a href=" http://data.org.sa/"> <img src="SaudidataSIGLogo.png" alt="The picture isn't downloaded properly" class="data-logo"></a>
    ...
    <div  class="about-section">
        ...
        <p style="justify-content: center; text-align:center">
          نحن مجموعة من أعضاء الفريق التابعين لمجموعة الاهتمام بعلم البيانات.      </p>
      ...
      <div class="container text-center">
        ...
        <div class="row">
        <div class="col-sm-4">
          <p class="text-center"><strong>محمد الغافلي  </strong></p><br>
...
<section class="p-5 z-depth-1">
  ...
  <h3 class="text-center font-weight-bold mb-5">وصلنا</h3>
  ...
  <div class="row d-flex justify-content-center">
    ...
    <div class="col-md-6 col-lg-3 mb-4 text-center">
      <h4 class="h1 font-weight-normal mb-3">
        ...
        <span class="d-inline-block count-up" data-from="0" data-to="500" data-time="2000">500</span>
      </h4>
      <p class="font-weight-normal text-muted">كتابة كلمات</p>
    </div>

  
    <div class="col-md-6 col-lg-3 mb-4 text-center">
      <h4 class="h1 font-weight-normal mb-3">
        <i class="fa fa-users indigo-text"></i>
        <span class="d-inline-block count2" data-from="0" data-to="150" data-time="2000">150</span>
      </h4>
      <p class="font-weight-normal text-muted">المشاركين</p>
    </div>
    
    <div class="col-md-6 col-lg-3 mb-4 text-center">
      <h4 class="h1 font-weight-normal mb-3">
        <i class="fa fa-laptop indigo-text"></i>
        <span class="d-inline-block count3" data-from="0" data-to="4" data-time="2000">4</span>
      </h4>
      <p class="font-weight-normal text-muted">المطورين</p>
    </div>
